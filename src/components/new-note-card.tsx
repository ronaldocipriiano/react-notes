              ...
              <div className='flex flex-1 flex-col gap-3 p-5'>
                ...
                {shouldShowOnboarding ? (
                  ...
                  Comece <button
                    ...
                    className='font-medium text-lime-400 hover:underline'>gravando uma nota</button>em áudio ou se preferir
                  <button 
                    type='button'
                  ...
                  <textarea
                    ...
                    className='w-full bg-transparent text-sm font-medium text-slate-400 outline-none resize-none flex-1'
